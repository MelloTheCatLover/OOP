package ru.nsu.kozoliy.gitFiles;
...
import ru.nsu.kozoliy.model.configs.GitConf;
import ru.nsu.kozoliy.model.configs.Student;
import ru.nsu.kozoliy.model.object.StudentInfo;
import ru.nsu.kozoliy.model.tasks.Task;

import java.io.File;
import java.io.IOException;
import java.util.List;

public class UserGitObserver implements AutoCloseable {
    Git git;
    ...
    public UserGitObserver(GitConf gitConfig, StudentInfo studentInfo,
