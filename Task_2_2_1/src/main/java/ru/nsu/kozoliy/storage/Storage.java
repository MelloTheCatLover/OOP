...
public class Storage {
     ...
     * <p>
     * Этот метод следует использовать с осторожностью,
     * так как он может вернуть устаревшее значение.
     * Следует учитывать, что после вызова этого метода
     * другой поток может добавить заказ в хранилище.
     * </p>
     *
